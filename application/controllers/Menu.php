...
class Menu extends CI_Controller
{
    ...
    public function deleteMenu($id)
    {
        ...
        $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">User Menu berhasil dihapus!</div>');
    ...
    public function deleteSubMenu($id)
    {
        ...
        // Set pesan sukses (flash message) jika diperlukan
        $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">User Sub Menu berhasil dihapus!</div>');
